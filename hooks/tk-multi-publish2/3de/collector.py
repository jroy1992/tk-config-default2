...
TDE4_SESSION_ITEM_TYPES = {
    "3de.session": {
        "icon_path": "{self}/hooks/icons/file.png",
        "type_display": "3dequalizer Session"
    },
}


class TDE4SessionCollector(HookBaseClass):
    """
    ...
    def __init__(self, parent, **kwargs):
        ...
        """
        # call base init
        super(TDE4SessionCollector, self).__init__(parent, **kwargs)
    ...
    def settings_schema(self):
        ...
        """
        schema = super(TDE4SessionCollector, self).settings_schema
        schema["Item Types"]["default_value"].update(TDE4_SESSION_ITEM_TYPES)
    ...
    def process_current_session(self, settings, parent_item):
        ...
        session_item = self.collect_current_3de_session(settings, parent_item)
    ...
    def collect_current_3de_session(self, settings, parent_item):
        ...
        if not file_path:
            ...
            self.logger.warning(
                "The 3de scene has not been saved.",
    ...
    def _resolve_work_path_template(self, settings, item):
        ...
        if item.type == "3de.session" and self.__workfiles_app:
        ...
        return super(TDE4SessionCollector, self)._resolve_work_path_template(settings, item)
    ...
    def _resolve_item_fields(self, settings, item):
        ...
        fields = super(TDE4SessionCollector, self)._resolve_item_fields(settings, item)
